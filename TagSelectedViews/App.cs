...
namespace TagSelectedViews
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass myButtonData = new ButtonDataClass("btnTagSelectedViews", "My Button", cmdTagSelectedViews.GetMethod(), Properties.Resources.Blue_32, Properties.Resources.Blue_16, "This is a tooltip");
